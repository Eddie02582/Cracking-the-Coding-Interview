...
public class PalindromePermutation {
   ...
   //My Solutions
    // boolean isPermutationOfPalindrom_array(String phrase)
    // {
    ...
    boolean isPermutationOfPalindrom_dict(String phrase)
    {
        ...
        //Dictionary<Character,Integer> count = new Hashtable<Character,Integer>();
